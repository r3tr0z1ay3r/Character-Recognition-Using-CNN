...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("Retro", "Retro"))
        self.BrowseImage.setText(_translate("Retro", "Browse Image"))
        self.label_2.setText(_translate("Retro", "GUJARATI CHARACTER RECOGNITION USING CNN"))
        self.Classify.setText(_translate("Retro", "Classify"))
        self.label.setText(_translate("Retro", "Recognized Class"))
        self.Training.setText(_translate("Retro", "Training"))
    ...
    def classifyFunction(self):
        json_file = open('F:\Python projects(Pycharm)\Pantech Course stuff\Character Recognition using CNN\model.json', 'r')
        loaded_model_json = json_file.read()
        json_file.close()
        loaded_model = model_from_json(loaded_model_json)
        # load weights into new model
        loaded_model.load_weights("Character Recognition using CNN/model.h5")
    ...
    def trainingFunction(self):
        ...
        training_set = train_datagen.flow_from_directory('F:\\Python projects(Pycharm)\\Pantech Course stuff\\Character Recognition using CNN\\Dataset\\train',
                                                         target_size = (128, 128),
                                                         batch_size = 8,
        ...
        test_set = test_datagen.flow_from_directory('F:\\Python projects(Pycharm)\\Pantech Course stuff\\Character Recognition using CNN\\Dataset\\test',
                                                    target_size = (128, 128),
                                                    batch_size = 8,
                                                    class_mode = 'categorical')
        ...
        with open("F:\Python projects(Pycharm)\Pantech Course stuff\Character Recognition using CNN\model.json", "w") as json_file:
            json_file.write(model_json)
        # serialize weights to HDF5
            model.save_weights("F:\Python projects(Pycharm)\Pantech Course stuff\Character Recognition using CNN\model.h5")
